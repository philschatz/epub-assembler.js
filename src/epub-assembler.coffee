  ...
  _buildFromToc: (navUri) ->
    ...
    .then () =>
      ...
      .then ($) =>
        ...
        $contentSkeleton = $('<div id="x-epub-content" data-type="epub-book"></div>')
        ...
        _.each $contentSkeleton.find('li > span'), (span) ->
          $span = $(span)
          $li = $span.parent()
          $heading = $('<h1 data-type="epub-toc-heading"></h1>')
          $span.replaceWith($heading)
          $heading.append($span.contents())

          $section = $('<div data-type="epub-toc-section"></div>')
        ...
        xincludePromises = _.map $contentSkeleton.find('a'), (a) =>
          ...
          .then (html) ->
            ...
            $constructedDiv = $('<div data-type="epub-toc-xref"></div>')
            ...
            #$constructedDiv.append('<p data-type="epub-debug-not-xincluding">ACTUAL_HTML_WOULD_GO_HERE</p>')
